...
const AboutSection = () => {
  ...
  return (
    <section className="text-white">
      <div className="md:grid md:grid-cols-2 gap-5 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 ">
         <Image src="/images/nisar.png" width={400} height={300} alt="About Image"/>
